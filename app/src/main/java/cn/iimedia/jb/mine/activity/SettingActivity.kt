...
class SettingActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.about_us_layout -> intentToWeb(mActivity, Config.ABOUT_US_URL, Config.ABOUT_US_TITLE)
            R.id.protocol_layout -> intentToWeb(mActivity, Config.USER_PROTOCOL, Config.PROTOCOL_TITLE)
            R.id.logout -> {
